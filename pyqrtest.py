...
if __name__ == "__main__":
    ...
    label_make = tk.Label(frame, text="Make", height=1)
    label_make.grid(column=0, row=0)
    input_make = tk.Text(frame, width=10, height=1)
    input_make.grid(column=1, row=0)
    
    label_model = tk.Label(frame, text="Model", height=1)
    label_model.grid(column=0, row=2)
    input_model = tk.Text(frame, width=10, height=1)
    input_model.grid(column=1, row=2)
    
    label_system = tk.Label(frame, text="System", height=1)
    label_system.grid(column=0, row=3)
    input_system = tk.Text(frame, width=10, height=1)
    input_system.grid(column=1, row=3)
    
    label_P1 = tk.Label(frame, text="P1", height=1)
    label_P1.grid(column=0, row=4)
    input_P1 = tk.Text(frame, width=10, height=1)
    input_P1.grid(column=1, row=4)
    
    label_P2 = tk.Label(frame, text="P2", height=1)
    label_P2.grid(column=0, row=5)
    input_P2 = tk.Text(frame, width=10, height=1)
    input_P2.grid(column=1, row=5)
    
    label_P3 = tk.Label(frame, text="P3", height=1)
    label_P3.grid(column=0, row=6)
    input_P3 = tk.Text(frame, width=10, height=1)
    input_P3.grid(column=1, row=6)
    
    label_P4 = tk.Label(frame, text="P4", height=1)
    label_P4.grid(column=0, row=7)
    input_P4 = tk.Text(frame, width=10, height=1)
    input_P4.grid(column=1, row=7)
    
    label_P5 = tk.Label(frame, text="P5", height=1)
    label_P5.grid(column=0, row=8)
    input_P5 = tk.Text(frame, width=10, height=1)
